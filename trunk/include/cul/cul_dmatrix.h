...
void      cul_dmatrix_zero(CulDMatrix *m);
...
cul_errno cul_dmatrix_resize(CulDMatrix *m, size_t x, size_t y);
cul_errno cul_dmatrix_resize_empty(CulDMatrix *m, size_t x, size_t y);
