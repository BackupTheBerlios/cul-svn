...
cul_errno cul_imatrix_insert_row       (CulIMatrix *this, size_t row, const CulIVectorView *other);
cul_errno cul_imatrix_insert_col       (CulIMatrix *this, size_t col, const CulIVectorView *other);
