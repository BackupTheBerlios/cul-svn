...
void      cul_pvector_each            (CulPVector *this, cul_each_f *each_f);
void      cul_pvector_each_prv        (CulPVector *this, cul_each_prv_f *each_prv_f, cul_ptr prv);
...
void      cul_pvectorview_each        (CulPVectorView *this, cul_each_f *each_f);
void      cul_pvectorview_each_prv    (CulPVectorView *this, cul_each_prv_f *each_prv_f, cul_ptr prv);
