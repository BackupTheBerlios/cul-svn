...
cul_errno cul_dmatrix_copy_view_offset(CulDMatrix *m, const CulDMatrixView *base_mv, size_t offset_x, size_t offset_y);
...
cul_errno cul_dmatrix_transpose_cpy(CulDMatrix *m, const CulDMatrix *base_m);
