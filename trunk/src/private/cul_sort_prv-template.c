...
void PFUNCTION(isort_asc)(ATOM *l,
                          ATOM *r)
{
...
void PFUNCTION(isort_asc_stride)(ATOM *l,
                                 ATOM *r,
                                 size_t stride)
{
    ATOM *const begin = l, *i, l_val;
...
void PFUNCTION(qsort_asc)(ATOM *l,
                          ATOM *r)
{
...
void PFUNCTION(qsort_asc_stride)(ATOM *l,
                                 ATOM *r,
                                 size_t stride)
{
    ATOM *const begin = l, *const last = r;
...
void PFUNCTION(isort_dsc)(ATOM *l,
                          ATOM *r)
{
    ATOM *const begin = l, *i, l_val;
    for (++l; l <= r; ++l) {
...
void PFUNCTION(isort_dsc_stride)(ATOM *l,
                                 ATOM *r,
                                 size_t stride)
{
    ATOM *const begin = l, *i, l_val;
...
void PFUNCTION(qsort_dsc)(ATOM *l,
                          ATOM *r)
{
    ATOM *const begin = l, *const last = r;
    ATOM *pivot = l, val;
...
void PFUNCTION(qsort_dsc_stride)(ATOM *l,
                                 ATOM *r,
                                 size_t stride)
{
    ATOM *const begin = l, *const last = r;
...
void FUNCTION(sort_asc)(ATOM *data,
                        size_t size)
{
    PFUNCTION(qsort_asc)(data, data + size - 1);
}

void FUNCTION(sort_asc_stride)(ATOM *data,
                               size_t size,
                               size_t stride)
{
...
void FUNCTION(sort_dsc)(ATOM *data,
                        size_t size)
{
    PFUNCTION(qsort_dsc)(data, data + size - 1);
}

void FUNCTION(sort_dsc_stride)(ATOM *data,
                               size_t size,
                               size_t stride)
{
...
void PFUNCTION(isort_stride)(ATOM *l,
                             ATOM *r,
                             size_t stride,
                             cul_cmp_f *cmp_f)
{
...
void PFUNCTION(qsort_stride)(ATOM *l,
                             ATOM *r,
                             size_t stride,
                             cul_cmp_f *cmp_f)
{
...
void FUNCTION(sort_stride)(ATOM *data,
                           size_t size,
                           size_t stride,
                           cul_cmp_f *cmp_f)
{
