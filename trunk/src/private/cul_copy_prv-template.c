void FUNCTION(copy_stride)(ATOM *restrict data,
                           const ATOM *restrict other,
                           size_t size,
                           size_t stride,
                           size_t other_stride)
{
...
void FUNCTION(copy_stride_data)(ATOM *restrict data,
                                const ATOM *restrict other,
                                size_t size,
                                size_t stride)
{
...
void FUNCTION(copy_stride_other)(ATOM *restrict data,
                                 const ATOM *restrict other,
                                 size_t size,
                                 size_t other_stride)
{
...
void FUNCTION(copy_tda)(ATOM *restrict data,
                        const ATOM *restrict other,
                        size_t size_x,
                        size_t size_y,
                        size_t tda,
